...
// JUMBF of C2PA manifest store. The size of the Vec returned from
// patch_manifest must be the same size as the source manifest_store.  The
// returned manifest is checked for validity and consistency.  You are not
